...
from app.api import auth, users, textures, products, projects, orders, confirmation, sketch, materials, store, admin, sales
...
app.include_router(admin.router, prefix="/api/v1/admin", tags=["管理员控制台"])
app.include_router(sales.router, prefix="/api/v1/sales", tags=["销售计算"])
